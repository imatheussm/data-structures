...
#     if not in_tree:
#         raise Exception("Element not in tree! Element: {}. Index: {}.".format(item,index))
#     else:
#         print(" found!")

# tree = BTree(2, [9,28,3,6,13,16,19,22,33,1,2,4,5,7,8,11,12,14,15,17,18,20,21,23,24,26,31,32,34,35])
