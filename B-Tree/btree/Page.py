...
class Page:
    ...
    def get_pages_of_height(self, height, current_pointer=None, current_height=1):
        """Returns all keys of Pages in the same height.
        ...
        height : int
            ...
            The height in which the desired Page objects are located.
        ...
        current_height : int (default = 1)
        
            The current height under analysis. If set to None, 1 will be set as the current_height.
        ...
        list
            ...
            The list of elements of the Page objects located in the desired height.
            
        Methodology
        -----------
        
        This method basically goes down recursively through the descendent Page objects until it reaches the desired height. These results are recursively appended into a list, which is returned at the end of the execution.
        """
        pages = []
        ...
        if current_height < height:
            if len(current_pointer.descendent_pages) > 0:
                for descendent in current_pointer.descendent_pages:
                    pages.append(
                        self.get_pages_of_height(height, descendent, current_height + 1)
                    )
                return pages
            else:
